...
static const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    // VBUS sense voltage divider when jumper connected https://docs.keeb.supply/0xcb-gemini/guide/#split-capability
